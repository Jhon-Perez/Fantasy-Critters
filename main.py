...
def main():
    ...
    grass1 = Grass(200,200,grass)
    grass2 = Grass(260,200,grass)
    grass3 = Grass(200,300,grass)
    grass4 = Grass(260,300,grass)
    ...
    while True:
        ...
        if pygame.sprite.spritecollideany(user, grass) and user.moving and random.randint(1,25)==1:
            print("collision")                 #This is the only issue, you check for if the object user collides with anything in the grass group
